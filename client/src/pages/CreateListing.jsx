    ...
    <main className=' p-2 max-w-3xl mx-auto'>
        ...
        <form className=' flex flex-col sm:flex-row gap-4'>
            <div className=' flex flex-col gap-2 flex-1'>
                <input type='text' placeholder='Name' className=' border p-2 rounded-md' id='name' maxLength='62' minLength='10' required />
                <textarea type='text' placeholder='Description' className=' border p-2 rounded-md' id='description' required />
                <input type='text' placeholder='Address' className=' border p-2 rounded-md' id='address' required />
            ...
            <div className=' flex flex-col flex-1 gap-2'>
                ...
                <button className=' p-3 bg-blue-500 text-white uppercase rounded-md hover:opacity-95 disabled:opacity-80'>Create Listing</button>
            </div>
        </form>
