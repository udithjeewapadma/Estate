...
export default function Profile() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className=' flex flex-col gap-2'>
      ...
      <input type='text' placeholder='username' defaultValue={currentUser.username} id='username' className=' border p-2 rounded-md' onChange={handleChange} />  
      <input type='email' placeholder='email' id='email' defaultValue={currentUser.email} className=' border p-2 rounded-md' onChange={handleChange} />
