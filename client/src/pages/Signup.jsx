  ...
  return (
    <div className=' p-3 max-w-md mx-auto'>
      ...
      <form onSubmit={handleSubmit} className=' flex flex-col gap-3'>
        <input type='text' placeholder='User Name' className=' border p-2 rounded-lg' id='username' onChange={handleChange} />
        ...
        <button disabled={loading} className=' bg-slate-800 text-white p-2 rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>
